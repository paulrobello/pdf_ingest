...
from ai_ocr.lib.par_ai_core.llm_providers import LlmProvider, is_provider_api_key_set, provider_base_urls
...
class LlmConfig:
    ...
    def _build_openai_compat_llm(self) -> BaseLanguageModel | BaseChatModel | Embeddings:
        ...
        if self.provider not in [LlmProvider.OPENAI]:
    ...
    def _build_llm(self) -> BaseLanguageModel | BaseChatModel | Embeddings:
        ...
        if self.provider in [LlmProvider.OPENAI]:
